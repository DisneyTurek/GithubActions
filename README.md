[![Run App DisneyTurek](https://github.com/DisneyTurek/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/DisneyTurek/GithubActions/actions/workflows/run-app.yaml)
